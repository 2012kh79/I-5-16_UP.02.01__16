...
//        public DataTable dtStandard = new DataTable("document");
//        public DataTable dtDepartment = new DataTable("dogovor");
//        public DataTable dtGroup = new DataTable("doljnost");
//        public DataTable dtStudent = new DataTable("firma");
//        public DataTable dtPost = new DataTable("firma_postavki");
//        public DataTable dtEmployee = new DataTable("ident_tov_party");
//        public DataTable dtCombination = new DataTable("instr_raboty_kassira");
//        public DataTable dtDiscipline = new DataTable("kadr_perestanovki");
//        public DataTable dtBurden = new DataTable("kadr_uchet");
//        public DataTable dtExercise_Type = new DataTable("medicamenti");
//        public DataTable dtJournal_of_the_lessons = new DataTable("post_tovar");
//        public DataTable dtPos = new DataTable("postavka");
//        public DataTable dtEmployee = new DataTable("postavshik");
//        public DataTable dtCombination = new DataTable("pribil_i_rashodi");
//        public DataTable dtDiscipline = new DataTable("prodaja_tovara");
//        public DataTable dtBurden = new DataTable("role");
//        public DataTable dtExercise_Type = new DataTable("soiskatel");
//        public DataTable dtJournal_of_the_lessons = new DataTable("sotrudnik");
